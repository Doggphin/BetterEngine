...
OBJFILES= vector3.o Quaternion.o physics.o geometry.o comp_collider.o vector2.o comp_rigidbody.o window.o gizmodrawer.o comp_cameracontroller.o comp_mesh.o comp_camera.o comp_entityrotator.o comp_playercontroller.o input.o ecs.o project.o
